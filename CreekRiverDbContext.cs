...
public class CreekRiverDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            new UserProfile {Id = 1, FirstName = "Marco", LastName = "Lorenzo", Email = "MLorenzo@gmail.com", List<Reservation> Reservations}
        });

        modelBuilder.Entity<Reservation>().HasData(new Reservations[]
        {
            new Reservations {Id = 1, CampsiteId = 1, UserProfileId = 1, CheckinDate = DateTime(2021, 3, 15), CheckoutDate = DateTime(2021, 3, 18) }
        });
    }
}